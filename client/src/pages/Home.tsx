...
const customerReviews = [
  "لذيذذذ مره فتحته على طوول يعطيك الف عافيه\nو عجب خالتي مررره تسلم يددك\nماراح يكون اخر تعامل باذن الله\nبعطيها رقمك و نعتمد مانجيب الا منك",
